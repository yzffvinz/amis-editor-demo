...
export function buildPageBody(signatureJson: string) {
    ...
    const {host, domain} = raw;
    const apis = {
        queryApi: `${host}/api/lc/${domain}/list`,
        addApi: `${host}/api/lc/${domain}/add`,
        deleteApi: `${host}/api/lc/${domain}/delete/\${_id}`,
        modifyApi: `${host}/api/lc/${domain}/modify`,
    }
